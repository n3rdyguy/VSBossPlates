...
**Version 0.1.3** - Vampire Survivors 1.15.x and the 1.16 public beta, BepInEx 6 IL2CPP.
...
`VS Boss Plates 0.1.3 loading...`. If that line is missing the plugin is not being loaded -
